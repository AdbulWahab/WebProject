...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4" >
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary" >Delete Fare!
      </h6>
    </div>
          ...
          <tbody>
            ...
            ?>
                ...
                <td><?php echo $row['class']; ?></td>
                  <td>
                    <form action="Manage_Fare/deleteFareQuery.php" method="post">
                      <input type="hidden" name="deleteFare" value="<?php echo $row['fid']; ?>">
