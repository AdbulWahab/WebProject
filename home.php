...
<head>
  ...
  <title>Train Managment System</title>
  <meta charset="utf-8">
...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="50">
  ...
  <nav class="navbar navbar-default navbar-fixed-top">
    <div class="container-fluid">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="#myPage">TMS</a>
      </div>
  ...
  <div class="container-fluid text-center bg-1">
    ...
    <div class="row text-center">
      ...
      <div class="col-sm-4">
        <div class="thumbnail">
          <img src="graphics/StationLahore.jpg" alt="lahore" width="450" height="300">
          <p><strong>Lahore Station</strong></p>
          <p></p>
        </div>
      </div>
      <div class="col-sm-4">
        <div class="thumbnail">
          <img src="graphics/StationKarahi.jpg" alt="Karachi" width="450" height="300">
          <p><strong>Karachi Station</strong></p>
          <p></p>
        </div>
      </div>
      ...
      <div class="row text-center">
        <div class="col-sm-4">
          <div class="thumbnail">
            <img src="graphics/StationBahawalpur.jpg" alt="Bahawalpur" width="450" height="300">
            <p><strong>Bahawalpur Station</strong></p>
            <p></p>
          </div>
        </div>
        ...
        <div class="col-sm-4">
          <div class="thumbnail">
            <img src="graphics/StationLalaMusa.jpg" alt="Lalamusa" width="450" height="300">
            <p><strong>Lalamusa Station</strong></p>
            <p></p>
          </div>
        </div>
        ...
        <div class="col-sm-4">
          <div class="thumbnail">
            <img src="graphics/StationFaisalabad.jpg" alt="Faisalabad width=" 450" height="300">
            <p><strong>Faisalabad Station</strong></p>
            <p></p>
          </div>
        </div>
  ...
  <div id="comments">
    <div class="container">
      ...
      <div class="form-group">
        <input type="text" class="form-control form-control-user" id="exampleInputEmail" placeholder="Comment">
      </div>
    </div>
  </div>
