...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4" >
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary" >Delete Route!
      </h6>
    </div>
          ...
          <tbody>
            ...
            ?>
                <tr>
                  ...
                  <td>
                    <form action="Manage_Route/deleteRouteQuery.php" method="post">
                      <input type="hidden" name="deleteRoute" value="<?php echo $row['rId']; ?>">
